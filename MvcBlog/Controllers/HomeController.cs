...
namespace MvcBlog.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var aranan = db.Makale.Where(m => m.Baslik.Contains(Ara)).ToList();
            return View(aranan.OrderByDescending(m=>m.Tarih));
        }

        public ActionResult SonYorumlar()
        {
            return View(db.Yorum.OrderByDescending(y => y.YorumId).Take(5));
        }

        public ActionResult PopulerMakaleler()
        {
            return View(db.Makale.OrderByDescending(m => m.Okunma).Take(5));
        }
        ...
        public JsonResult YorumYap(string yorum, int Makaleid)
        {
            ...
            db.Yorum.Add(new Yorum { UyeId = Convert.ToInt32(uyeid), MakaleId = Makaleid, Icerik = yorum, Tarih = DateTime.Now });
            db.SaveChanges();
        ...
        public ActionResult YorumSil(int id)
        {
            ...
            var makale = db.Makale.Where(m => m.MakaleId == yorum.MakaleId).SingleOrDefault();
        ...
        public ActionResult OkunmaArttır(int Makaleid)
        {
